...
#define principal              int main(int argc, char *argv[]) { std::setlocale(LC_ALL,"es_AR.iso88591"); //"es_AR.UTF-8" unitbuf(cout);
...
//#define esAlgo(car,cad)        (posCarEnCad(car,cad) < std::string::npos)
...
//#define esLetra(x)             esAlgo(x,"ABCDEFGHIJKLMN�OPQRSTUVWXYZabcdefghijklmn�opqrstuvwxyz������������")
inline logico esLetra(caracter car) {
regresa(esAlgo(car,"ABCDEFGHIJKLMN�OPQRSTUVWXYZabcdefghijklmn�opqrstuvwxyz������������"));
}

//#define esVocalAcentuada(x)    (logico)(strchr("����������",x))
inline logico esVocalAcentuada(caracter car) {
regresa(esAlgo(car,"áéíóúÁÉÍÓÚ"));
}
...
#define esVocal(x)             esAlgo(x,"AEIOUaeiou������������")
#define esVocalAcentuada(x)    esAlgo(x,"����������")
#define esUconDieresis(x)      esAlgo(x,"��")
#define esVocalAbierta(x)      esAlgo(x,"AEOaeo������"))
#define esVocalCerrada(x)      esAlgo(x,"IUiu������"))
...
#define esLetra(x)             (logico)(strchr("ABCDEFGHIJKLMN�OPQRSTUVWXYZabcdefghijklmn�opqrstuvwxyz������������",x))
#define esSigno(x)             (NO (esLetra(x) O esDigito(x)))
#define esUconDieresis(x)      (logico)(strchr("��",x))
#define esVocal(x)             (logico)(strchr("AEIOUaeiou������������",x))
#define esVocalAbierta(x)      (logico)(strchr("AEOaeo������",x))
#define esVocalCerrada(x)      (logico)(strchr("IUiu������",x))
#define esDiptongo(x,y)        (esVocal(x) Y esVocal(y) Y NEQV(esVocalAbierta(x),esVocalAbierta(y)))
#define esTriptongo(x,y,z)     (logico)(esVocalCerrada(x) Y esVocalAbierta(y) Y esVocalCerrada(z))
#define esHiato(x,y)           (esVocalAbierta(x) Y esVocalAbierta(y))

#define derecha(cadX,n)        (cadX.substr((cadX.size()-n-1),(n)))
...
cadena resul = cad
      ,origen = "ABCDEFGHIJKLMN�OPQRSTUVWXYZ������"
      ,destino = "abcdefghijklmn�opqrstuvwxyz������";
